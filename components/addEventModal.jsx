...
import AddFamilyModal from "./addModals/addFamilyModal";
import AddTimingModal from "./addModals/addTimingModal";
import AddElementsModal from "./addModals/addElementsModal";
import axios from "axios";
import AddPeriodModal from "./addModals/addPeriodModal";
...
export default function AddEventModal({addEventModal, setAddEventModal}) {
  ...
  return (
    ...
    >
      <ScrollView style={styles.addEventModal}>
        <View style={styles.topPanel}>
          <TouchableOpacity onPress={() => setAddEventModal(false)}>
            <Image
